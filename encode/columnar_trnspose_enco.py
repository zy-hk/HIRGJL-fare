...
#rearranges corespondence to the rearranged key
for i in corespondence[regar_key[0]]:
    alltext.append(i)
for i in corespondence[regar_key[1]]:
    alltext.append(i)
for i in corespondence[regar_key[2]]:
    alltext.append(i)
for i in corespondence[regar_key[3]]:
    alltext.append(i)
